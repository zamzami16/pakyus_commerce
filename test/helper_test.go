...
// RegisterTestUser creates a test user and returns the entity with generated UUID
func RegisterTestUser(t *testing.T) *entity.User {
	user := &entity.User{
		ID:       uuid.New(),
		Name:     "Test User",
		Password: "$2a$10$test_hashed_password", // bcrypt hash for "rahasia"
	}
